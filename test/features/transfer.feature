Feature: Transfer
  ...
  Scenario: Transfer in a domain with importing DNS settings steps
    ...
    And I should see "Found These DNS Settings. Import into Badger?"
    And I should see "Import these settings into Badger DNS"
    ...
    And I should see "TTL" within "#dns-settings tr"
    And I should see "Priority" within "#dns-settings tr"
    ...
    And I should see "41" within "#dns-settings"
    ...
    And I should see "86399" within "#dns-settings"
    ...
    And I should see "abc.com." within "#dns-settings"
    And I should see "1590" within "#dns-settings"
    And I should see "MX" within "#dns-settings"
    And I should see "aspmx.l.abc.com." within "#dns-settings"
    And I should see "abc.com." within "#dns-settings"
    And I should see "600" within "#dns-settings"
    And I should see "10" within "#dns-settings"
    And I mock registerDomain api
    And I press "Next"
    And I press "Transfer abc.com for 1 Credit"
    Then I should see "Transfer Request Submitted"
