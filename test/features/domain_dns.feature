Feature: Badger DNS
  ...
  Scenario: When I visit Badger DNS page for my domain, I should see all DNS application I have installed (Email Forwarding ad Google Calendar) in sorted order
    ...
    And I should see "v=spf2 mx mx:rhinonamesmail.com ~all" within "#content table:first tr:eq(10)"
    ...
    And I should see "v=spf1 mx mx:rhinonamesmail.com ~all" within "#content table tr:eq(13)"
