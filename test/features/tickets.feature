Feature: Tickets
  ...
  Scenario: View all pending and closed tickets
    ...
    And I should see "Created At" within "#content table:first"
    And I should see "Updated At" within "#content table:first"
    ...
    And I should see "Sat Jan 28 2012" within "#content table:first tr:eq(2)"
    And I should see "Tue Jan 31 2012" within "#content table:first tr:eq(2)"
    And I should see "open" within "#content table:first tr:eq(2)"
    And I should see "Your Closed Tickets"
    And I should see "Subject" within "#content div:eq(3) table"
    And I should see "Category" within "#content div:eq(3) table"
    And I should see "Created At" within "#content div:eq(3) table"
    And I should see "Updated At" within "#content div:eq(3) table"
    And I should see "Status" within "#content div:eq(3) table"
    And I should see "Request Feature 0" within "#content div:eq(3) table tr:eq(2)"
    And I should see "Request Feature" within "#content div:eq(3) table tr:eq(2)"
    And I should see "Sat Jan 28 2012" within "#content div:eq(3) table tr:eq(2)"
    And I should see "Tue Jan 31 2012" within "#content div:eq(3) table tr:eq(2)"
    And I should see "closed" within "#content div:eq(3) table tr:eq(2)"
  ...
  Scenario: View and response to a ticket
    ...
    And I should see "Sat Jan 28 2012"
    And I should see "Updated At"
    And I should see "Tue Jan 31 2012"
  ...
  Scenario: Create a new ticket
    ...
    When I press "Submit"
    Then I should see "Your ticket has been created!"