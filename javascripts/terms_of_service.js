...
with (Hasher.View('TermsOfService', 'Application')) {
  create_view('terms_of_service', function() {
    return div(
      ...
      p('5.2. You shall provide to Rhinonames.com, accurate and reliable contact details and promptly correct and update them during the term of registration of the Registered Name, including:'),
      ...
      p('6.1. The applicable fees for the registration or renewal of a Registered Name must be paid in full and any identification or authorization documents requested shall be provided to Rhinonames.com at the time of submitting the domain name registration or renewal application, as the case may be. Rhinonames.com reserves the right to not process a domain name registration or renewal until all applicable fees have been paid, the funds cleared and any requested identification or authorization documents have been received by Rhinonames.com. All fees are non-refundable.'),
      p('6.2. All payments of fees for the Services provided by Rhinonames.com shall be made in U.S. dollars.'),
      p('6.3. In the event that you fail to pay any and all moneys owed to Rhinonames.com as and when they are due and payable ("Debt"), or if any requested identification or authorization documents are not provided, then Rhinonames.com shall be entitled in its sole discretion, to take any or all of the following actions:'),
      p('(a) immediately suspend access to your Rhinonames.com account;'),
      p('(b) assume full control of all of the Registered Names in your Rhinonames.com account;'),
      p('(c) transfer some or all of the Registered Names in your Rhinonames.com account to Rhinonames.com or its nominee, in partial or total satisfaction of the Debt. You hereby irrevocably appoint Rhinonames.com as your attorney for the purposes of entering into any transaction and executing any document required to give effect to this clause'),
      ...
      p('7.6. You consent to your Personal Information being processed, stored and used in accordance with this clause 7 and the Rhinonames.com Privacy Policy.'),
      p('7.7. You undertake to provide a copy of this clause 7 and the Rhinonames.com Privacy Policy to any third-party individuals whose Personal Information is to be supplied to Rhinonames.com by you and obtain the consent of such third party individuals before disclosing their Personal Information to Rhinonames.com.'),
      ...
      p('9.2. Rhinonames.com does not guarantee that you will be able to register or renew a particular domain name, even if a preliminary search or inquiry indicates that the domain name is available. This may be due to:'),
      ...
      p('9.3. Rhinonames.com may in its sole and absolute discretion, accept or reject your application for the registration or renewal of a particular domain name.'),
      p('9.4. Rhinonames.com is not responsible or liable in any way for any errors, omissions or any other actions or inactions by the Registry arising out of or in connection with your application for registration or renewal of a particular domain name, or a failure to register or renew a particular domain name.'),
      p('9.5. To the maximum extent permitted by law, Rhinonames.com disclaims all warranties and guarantees, whether express or implied, regarding the Services or any other services that Rhinonames.com may perform for you from time to time. To the extent that such warranties or guarantees cannot be disclaimed by law, you agree that the liability of Rhinonames.com shall be limited to the re-supply of the service.'),
      ...
      p('(i) correcting mistakes by Rhinonames.com or any central domain name registry operator (including the Registry) in registering, renewing and/or transferring the Registered Names; or'),
